...
setup(
    name="MadisonTaskDefinitionIntellisense",
    version="1.0",
    ...
    #
    # 1. Create the function you want to run on the CLI in src/madison_task_definition_intellisense/cli.py
    #    For convenience I usually recommend calling it main()
    #
    # 2. Uncomment this section of the setup.py arguments; this will create
    #    bin/MadisonTaskDefinitionIntellisense (which you can obviously change!) as a script
    #    that will call your main() function, above.
    #
    # entry_points="""\
    # [console_scripts]
    # MadisonTaskDefinitionIntellisense = madison_task_definition_intellisense.cli:main
    # """,
    #
